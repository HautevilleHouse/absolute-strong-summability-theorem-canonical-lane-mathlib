...
/-!
# Source dependency model for `absolute-strong-summability-theorem-canonical-lane`
...
def sourceImportDependencies : List SourceImportDependency := [
  ...
  { file := "scripts/ass_closure_guard.py", kind := "from_import", module := "__future__", name := "annotations", alias := "", level := 0 },
  { file := "scripts/ass_closure_guard.py", kind := "import", module := "argparse", name := "", alias := "", level := 0 },
  { file := "scripts/ass_closure_guard.py", kind := "import", module := "datetime", name := "", alias := "dt", level := 0 },
  { file := "scripts/ass_closure_guard.py", kind := "import", module := "json", name := "", alias := "", level := 0 },
  { file := "scripts/ass_closure_guard.py", kind := "import", module := "math", name := "", alias := "", level := 0 },
  { file := "scripts/ass_closure_guard.py", kind := "from_import", module := "pathlib", name := "Path", alias := "", level := 0 },
  { file := "scripts/ass_closure_guard.py", kind := "from_import", module := "typing", name := "Any", alias := "", level := 0 },
...
def sourcePathDependencies : List SourcePathDependency := [
  { file := "scripts/extract_constants.py", name := "DEFAULT_INPUTS", path := "artifacts/ass_constants_extraction_inputs.json", role := "artifact", line := 17 },
  { file := "scripts/extract_constants.py", name := "DEFAULT_OUT", path := "artifacts/ass_constants_extracted.json", role := "artifact", line := 18 },
  { file := "scripts/ass_closure_guard.py", name := "DEFAULT_REGISTRY", path := "artifacts/ass_constants_registry.json", role := "artifact", line := 16 },
  { file := "scripts/ass_closure_guard.py", name := "DEFAULT_STITCH", path := "artifacts/ass_stitch_constants.json", role := "artifact", line := 17 },
  { file := "scripts/ass_closure_guard.py", name := "DEFAULT_OUT", path := "repro/ass_certificate_runtime.json", role := "repro", line := 18 },
  { file := "scripts/ass_closure_guard.py", name := "DEFAULT_HISTORY", path := "repro/ass_drift_guard_runs.jsonl", role := "repro", line := 19 },
  { file := "scripts/promote_constants.py", name := "DEFAULT_EXTRACTED", path := "artifacts/ass_constants_extracted.json", role := "artifact", line := 16 },
  { file := "scripts/promote_constants.py", name := "DEFAULT_REGISTRY", path := "artifacts/ass_constants_registry.json", role := "artifact", line := 17 },
  { file := "scripts/promote_constants.py", name := "DEFAULT_STITCH", path := "artifacts/ass_stitch_constants.json", role := "artifact", line := 18 },
  { file := "scripts/promote_constants.py", name := "DEFAULT_REPORT", path := "artifacts/ass_promotion_report.json", role := "artifact", line := 19 },
  { file := "scripts/release_gate.py", name := "DEFAULT_MANIFEST", path := "repro/ass_repro_manifest.json", role := "repro", line := 17 },
  { file := "scripts/release_gate.py", name := "DEFAULT_REGISTRY", path := "artifacts/ass_constants_registry.json", role := "artifact", line := 18 },
  { file := "scripts/release_gate.py", name := "DEFAULT_INPUTS", path := "artifacts/ass_constants_extraction_inputs.json", role := "artifact", line := 19 },
  { file := "scripts/update_manifest.py", name := "DEFAULT_MANIFEST", path := "repro/ass_repro_manifest.json", role := "repro", line := 16 }
]
