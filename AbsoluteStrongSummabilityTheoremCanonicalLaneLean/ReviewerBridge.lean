...
def reviewerChainSteps : List ReviewerChainStep :=
  [{ index := 1, label := "ASS_EG1" },
   { index := 2, label := "ASS_EG2" },
   { index := 3, label := "ASS_EG3" },
   { index := 4, label := "ASS_EG4" },
   { index := 5, label := "Identification bridge" },
   { index := 6, label := "Absolute closure" }]

def reviewerClosureGates : List ReviewerClosureGate :=
  [{ gate := "ASST_G1", constant := "alpha_coercive" },
   { gate := "ASST_G2", constant := "sigma_capture" },
   { gate := "ASST_G3", constant := "kappa_compact" },
   { gate := "ASST_G4", constant := "rho_rigidity" },
   { gate := "ASST_G5", constant := "summability_factor" },
   { gate := "ASST_G6", constant := "eps_coh" },
   { gate := "ASST_GM", constant := "derived" }]
...
def reviewerManifestEntries : List ReviewerManifestEntry :=
  [{ path := "CITATION.cff", sha256 := "8ab4c96423e62309dab37f9bc69c7f1d9ca6d5dc52396d3011c387d3b55b48f2" },
   ...
   { path := "notes/ASS_EG1_public.md", sha256 := "0cbaa78309e7cfd1481beca4012eb4638bcef482ffd7995f5ae872e026334d69" },
   { path := "notes/ASS_EG2_public.md", sha256 := "2099f8312a3cabef5a9eed9aa790e23b433da964da147ad650a02d0202e6b19e" },
   { path := "notes/ASS_EG3_public.md", sha256 := "cd92aed87f8baa5e5a5996fa84c7482dc436dd539e875ffbd4fb3e2665ef1aab" },
   { path := "notes/ASS_EG4_public.md", sha256 := "2b1cfe4706c84ce9d4058fad89a9808a50f1a2d2d41a2dddb7116ea4cd69ad15" },
   ...
   { path := "paper/ABSOLUTE_STRONG_SUMMABILITY_PREPRINT.md", sha256 := "40bafa143a1f2ef7c30cad74b97a9f94f40d260a834942408f7427346496ea83" },
   ...
   { path := "scripts/asst_closure_guard.py", sha256 := "b3f9a07dea48beb963e959c2196b438c3f64e119c4f0a7f524f7d6b6d158746f" },
   { path := "scripts/README.md", sha256 := "a3c6ba5b7447b69e1bcdec70aa16fc4c9f94c87038ef7293588414a6f85f0d1b" }]

def baselineCertificateGates : List CertificateGate :=
  [{ gate := "ASST_G1", status := "PASS" },
   { gate := "ASST_G2", status := "PASS" },
   { gate := "ASST_G3", status := "PASS" },
   { gate := "ASST_G4", status := "PASS" },
   { gate := "ASST_G5", status := "PASS" },
   { gate := "ASST_G6", status := "PASS" },
   { gate := "ASST_GM", status := "PASS" }]

def baselineCertificateInputs : List CertificateInput :=
  [{ key := "eps_coh", value := "0.0" },
   { key := "summability_factor", value := "1.0307999999999997" },
   { key := "alpha_coercive", value := "1.100325" },
...
def baselineCertificateLane : String := "summability_constrained"
